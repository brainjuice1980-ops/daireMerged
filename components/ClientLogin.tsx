...
const ClientLogin: React.FC<ClientLoginProps> = ({ onSuccess, onBack, onSignup, onForgotPassword }) => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(`${supabaseUrl}/functions/v1/client-login`, {
        method: 'POST',
        headers: {
